...
A power-law spectrum is obtained in the steady state only when the acceleration time and the escape time both have the same energy dependence. In this particular case, the steady state solution is given by
$$
N(E) = N_0 \left( \frac{E}{E_0} \right)^{-q}
\quad
q \equiv \frac{\tau_{\rm acc}}{\tau_{\rm esc}} + 1
$$
